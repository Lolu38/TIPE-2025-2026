...
Q_TABLE_FILE = "Dossier_enregistrement/full_ray/q_table.csv"
SCORES_FILE = "Dossier_enregistrement/full_ray/scores.csv"
...
def get_ray_distances(obs, car_angle=0.0, num_rays=7, max_distance=50, step=1, cone=np.pi/2, debug=False):
    h, w, _ = obs.shape
    cx, cy = w // 2, h // 2
